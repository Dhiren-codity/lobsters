...
RSpec.describe Comment do
  describe ".regenerate_markdown" do
    it "updates markeddown_comment for all comments" do
  ...
  describe "#as_json" do
    it "returns a hash representation of the comment" do
      ...
      expect(json).to include(:short_id, :created_at, :last_edited_at, :is_deleted, :is_moderated, :score, :flags, :depth)
  ...
  describe "#delete_for_user" do
    it "marks comment as deleted and moderated by a moderator" do
      mod = create(:user, :moderator)
      comment = create(:comment)
      comment.delete_for_user(mod, "Inappropriate")
  ...
  describe "#generated_markeddown_comment" do
    it "generates markdown from comment text" do
      comment = build(:comment, comment: "This is **bold** text")
