...
class User < ApplicationRecord
  ...
  def as_json(_options = {})
    ...
    attrs << :karma unless is_admin?
    attrs << :homepage

    # Build a symbol-keyed hash with only desired attributes
    base = attributes.symbolize_keys
    h = base.slice(*attrs)
  ...
  def recent_threads(amount, include_submitted_stories: false, for_user: nil)
