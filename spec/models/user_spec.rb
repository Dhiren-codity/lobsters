...
RSpec.describe User, type: :model do
  ...
  describe "#as_json" do
    ...
    it "omits karma for admins and omits oauth usernames when blank" do
      allow(Markdowner).to receive(:to_html).and_return("<p>about html</p>")
      u = create(:user, username: "adminuser", is_admin: true, github_username: nil, mastodon_username: nil, mastodon_instance: nil)
  ...
  describe "#refresh_counts!" do
    it "updates keystore-backed counters for stories and comments" do
      ...
      s3 = create(:story, user: u)
      c1 = create(:comment, user: u, is_deleted: false)
      c2 = create(:comment, user: u, is_deleted: false)
      c3 = create(:comment, user: u, is_deleted: true)
