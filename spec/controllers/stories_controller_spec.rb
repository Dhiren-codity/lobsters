...
RSpec.describe StoriesController do
  ...
  describe '#unvote' do
    ...
    context 'when story is found' do
      it 'unvotes the story and renders ok' do
  ...
  describe '#upvote' do
    ...
    context 'when story is found' do
      it 'upvotes the story and renders ok' do
        allow(controller).to receive(:find_story).and_return(story)
  ...
  describe '#flag' do
    ...
    context 'when user can flag the story' do
      it 'flags the story and renders ok' do
        allow(controller).to receive(:find_story).and_return(story)
        allow(controller).to receive(:params).and_return(reason: 'spam')
  ...
  describe '#hide' do
    ...
    context 'when story is found' do
      it 'hides the story and renders ok' do
        allow(controller).to receive(:find_story).and_return(story)
  ...
  describe '#unhide' do
    ...
    context 'when story is found' do
      it 'unhides the story and renders ok' do
        allow(controller).to receive(:find_story).and_return(story)
  ...
  describe '#save' do
    ...
    context 'when story is found' do
      it 'saves the story and renders ok' do
        allow(controller).to receive(:find_story).and_return(story)
  ...
  describe '#unsave' do
    ...
    context 'when story is found' do
      it 'unsaves the story and renders ok' do
        allow(controller).to receive(:find_story).and_return(story)
