...
RSpec.describe SettingsController do
  ...
  describe '#deactivate' do
    context 'when "I am sure" checkbox is not checked' do
      it 'redirects to settings path with error message' do
    ...
    context 'when "I am sure" checkbox is checked and password is correct' do
      it 'deletes the user and redirects to root path with success message' do
        ...
        post :deactivate, params: { user: { i_am_sure: "1", password: "password", disown: "1" } }
  ...
  describe '#update' do
    ...
    context 'when current password is correct' do
      it 'updates user settings and renders index with success message' do
        allow(user).to receive(:authenticate).and_return(true)
  ...
  describe '#twofa_auth' do
    context 'when password is correct' do
      it 'disables 2FA and redirects to settings with success message' do
        allow(user).to receive(:authenticate).and_return(true)
    ...
    context 'when password is incorrect' do
      it 'redirects to twofa_url with error message' do
        allow(user).to receive(:authenticate).and_return(false)
